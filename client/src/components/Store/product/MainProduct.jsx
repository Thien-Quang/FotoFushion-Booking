...
const MainProducts = () => {
  ...
  const addProduct = async (id, quantity) => {
    const response = await addProductServices.addProductToCart(
      auth.accessToken,
      auth.id,
      id,
      quantity
  ...
  return (
    <>
      ...
      <img
        className="w-full"
        src="https://firebasestorage.googleapis.com/v0/b/fotofushion-51865.appspot.com/o/FrojectImage%2Fbgshop.png?alt=media&token=4e3f4f50-988d-44fe-be90-16ed54a6cb92"
        alt=""
      />
