...
const hoso = () => {
  return (
    <div className="max-w-4xl max-h-2xl bg-white text-black rounded-xl flex items-center justify-center">
      <div className="w-3/4 ">
        <span className="m-4 font-Montserrat font-bold text-2xl p-4 border-b border-black flex items-center justify-center">
          HỒ SƠ CỦA TÔI
        </span>
        <div className="flex items-center justify-center">
          <div className="w-[80%]">
            <div className="m-4">
              ...
              <input
                className="w-full h-10 border mt-3 border-gray-500 rounded-2xl pl-4"
                type="text"
      ...
      <div className="w-1/4 ">
        <div className="flex items-center justify-center">
          <div className="w-[160px] h-[160px] bg-orange-500 rounded-full flex items-center justify-center"></div>
        </div>
        <div className="flex items-center justify-center">
