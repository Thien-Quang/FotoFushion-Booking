...
const getListProductsByStoreApi = async ({ orderBy, sortBy, q, limit, page, categoryId, rating, minPrice, maxPrice, storeId, }) => {
...
const getListProductsByUserApi = async ({ orderBy, sortBy, q = "", limit, page, categories = [], rating, minPrice, maxPrice, storeId, }) => {
  const res = await axiosClient.get(
