...
const AddPriceList = () => {
  ...
  const [number_assistant_photographer, setNumber_assistant_photographer] =
    useState("");
  ...
  useEffect(() => {
    const fetchAdd = async () => {
      try {
        const addPrice = await pricelist.CreateAPriceForAlbums(
          auth.accessToken,
          name,
          price,
          number_camera,
      ...
      <div className="flex items-center justify-center">
        <div className="w-2/3 bg-black h-auto m-4 p-4 flex items-center justify-center">
          <span className=" text-white text-2xl">
            Thêm một giá mới cho albums hình ảnh{" "}
          </span>
        </div>
      </div>
        ...
        <div className="flex items-center justify-center">
          <div className="w-[80%] p-8 border border-black rounded-lg shadow-xl">
            <form action="" onSubmit={(e) => handleSubmit(e)}>
              ...
              <div className="flex flex-col mb-6">
                <label
                  className="font-medium text-left text-lg mb-2 text-black "
                  htmlFor=""
                >
                  Nhập tên gói chụp
                </label>
              ...
              <div className="w-full flex items-center justify-between">
                ...
                <div className="w-[32%] flex flex-col mb-6">
                  ...
                  <input
                    ...
                    placeholder="....... thợ"
                    onChange={(event) =>
                      setNumber_photographer(event.target.value)
                    }
                ...
                <div className="w-[32%] flex flex-col mb-6">
                  ...
                  <input
                    ...
                    placeholder="...... thợ"
                    onChange={(event) =>
                      setNumber_assistant_photographer(event.target.value)
                    }
              ...
              <div className="flex flex-col mb-6">
                <label
                  ...
                  htmlFor=""
                >
                  Nhập mô tả như số buổi chụp , xem ảnh , hỗ trợ đạo cụ ,trang
                  phục , trang điểm
                </label>
                <textarea
