    ...
    <>
      ...
      <div className="h-screen flex items-center bg-gradient-to-r from-[#444444] to-[#000000]">
        <div className="bg-[#2d2e2e]  w-full sm:w-[90%] md:w-[80%] lg:w-[75%] lg:grid lg:grid-cols-10 shadow-xl mx-auto rounded-[20px] pb-4 lg:pb-0">
              ...
              <form action="" onSubmit={(e) => handleSubmit(e)}>
                <div className="flex flex-col mb-2">
                  ...
                  <input
                    ...
                    onChange={(event) =>
                      setEmail(replaceEmail(event.target.value))
                    }
                    value={email}
                  />
                </div>
          ...
          <div className="hidden lg:block h-full w-full col-span-6 bg-black">
            <div className="h-full w-full object-cover lg:rounded-r-[20px] ">
              <Carousel slideInterval={2000}>
                <img
                  src="https://firebasestorage.googleapis.com/v0/b/fotofushion-51865.appspot.com/o/FrojectImage%2Fslide-regis%2F409545090_1105994830843230_2157843334834832738_n.jpg?alt=media&token=c6f0af1d-c9d3-4170-97c7-7ae9d6a4b9cc"
                  alt="..."
                />
                <img
                  src="https://firebasestorage.googleapis.com/v0/b/fotofushion-51865.appspot.com/o/FrojectImage%2Fslide-regis%2F409548079_2109107996105184_6936437252922352272_n.jpg?alt=media&token=54094487-e973-434f-a685-e65b4c133332"
                  alt="..."
                />
                <img
                  src="https://firebasestorage.googleapis.com/v0/b/fotofushion-51865.appspot.com/o/FrojectImage%2Fslide-regis%2F409554895_24360487113597594_3118450683455908892_n.jpg?alt=media&token=091f7f9c-6a1b-4235-962b-3c12d4b82160"
                  alt="..."
                />
                <img
                  src="https://firebasestorage.googleapis.com/v0/b/fotofushion-51865.appspot.com/o/FrojectImage%2Fslide-regis%2F409812054_1105994904176556_7732531811464827346_n.jpg?alt=media&token=158d8d71-680e-4592-9bd1-3f10a4dc3c3b"
                  alt="..."
                />
                <img
                  src="https://firebasestorage.googleapis.com/v0/b/fotofushion-51865.appspot.com/o/FrojectImage%2Fslide-regis%2F409848838_2282567431934405_2556037988827419922_n.jpg?alt=media&token=8bc6aef8-65d1-44f7-9088-242ff08b64f9"
                  alt="..."
                />
              </Carousel>
            </div>
          ...
          >
            <Modal.Header>
              <h1 className="font-semibold text-orange-500 text-3xl ">
                Email Verification
              </h1>
            </Modal.Header>
            <Modal.Body>
              <div className="flex items-center justify-center m-4">
                <h1 className="font-semibold text-black text-sm ">
                  Mã otp được gửi đến Gmail : {email}{" "}
                </h1>
              </div>
            ...
            <Modal.Footer>
              <div className="flex items-center justify-center m-2">
                ...
                <button className="flex flex-row items-center text-blue-600 m-2">
                  Gửi lại
                </button>
              </div>
            </Modal.Footer>
