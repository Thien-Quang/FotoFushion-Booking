  ...
  return (
    <div>
      <div className="w-full">
        <img
          src="https://firebasestorage.googleapis.com/v0/b/fotofushion-51865.appspot.com/o/FrojectImage%2Fbgequipment.png?alt=media&token=6da0b9c1-ea94-4d28-966f-41c41b795127"
          alt=""
        />
      </div>
      ...
      <div className="w-full space-y-3 sm:space-y-0 sm:grid sm:grid-cols-1 sm:gap-6 md:grid-cols-3 md:max-w-5xl md:mx-auto xl:grid-cols-4">
        {currentStudios.map((studio) => (
          <div
            key={studio.id}
            className="card w-64 bg-base-100 shadow-xl flex items-center justify-center"
          >
            <div className="w-64">
            ...
            <div className="card-body">
              ...
              <p>
                {studio.price} .VND / {studio.rental_start_date}
              </p>
      ...
      <div className="flex items-center justify-center m-4">
        <div className="pagination join">
          {Array.from({
            length: Math.ceil(equipments.length / itemsPerPage),
          }).map((_, index) => (
            <input
              key={index + 1}
