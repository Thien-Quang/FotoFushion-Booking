  ...
  return (
    <div className="w-full h-auto border">
      <div className="flex items-start justify-center m-2">
        ...
        <div className="flex py-2 px-4 mb-4 bg-white rounded-lg rounded-t-lg border border-gray-200 w-[80%]">
          <textarea
            id="comment"
            rows="1"
      ...
      <div className="flex items-start justify-center">
        <div className="w-4/5 flex items-start justify-center">
          ...
          <div className="w-[90%] border bg-gray-100 p-1 rounded-xl my-2">
            ...
            <div className="px-2">
              <h2>
                Hình chụp đẹp quá .Tôi muốn chụp theo phong cách này thì xem báo
                giá ở đâu vậy{" "}
              </h2>
            </div>
            <div className="flex">
