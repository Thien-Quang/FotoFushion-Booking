          ...
          <div className="py-4 px-6 flex items-center justify-center">
            <div className="p-4 rounded shadow-sm m-2 w-full text-white">
              <div className="flex items-center justify-center">
                <label
                  className="block  font-bold mb-2 text-3xl text-white"
                  for="name"
                >
                  Thông Tin Cá Nhân
                </label>
              ...
              <div className="mb-4 w-[48%]">
                ...
                <input
                  className={`input input-bordered ${
                    isEditing ? "input-warning" : ""
                  } w-full max-w-xs text-black font-semibold  max-sm:text-xs leading-tight focus:outline-none focus:shadow-outline`}
                  id="name"
                  type="text"
              ...
              <div className="mb-4 w-[48%]">
                ...
                <input
                  className={`input input-bordered ${
                    isEditing ? "input-warning" : ""
                  } w-full max-w-xs text-black max-sm:text-xs font-semibold leading-tight focus:outline-none focus:shadow-outline`}
                  id="phoneNumber"
                  type="number"
              ...
              <div className="mb-4 max-sm:text-xs">
                ...
                <input
                  className={`input input-bordered ${
                    isEditing ? "input-warning" : ""
                  } w-full max-w-xs max-sm:text-xs text-black font-semibold leading-tight focus:outline-none focus:shadow-outline`}
                  id="email"
                  type="email"
              ...
              <div className="mb-4 max-sm:text-xs">
                <label className="block text-white font-bold mb-2" for="gender">
                  Giới Tính
                </label>
                {isEditing ? (
                  <select
                  ...
                  <input
                    ...
                    type="text"
                    value={
                      auth.gender === null ? "Chưa có thông tin" : auth.gender
                    }
                    readOnly
                  />
                )}
              ...
              <div className="ml-[15%]">
                {isEditing ? (
                  ...
                  <Button
                    className="bg-green-400 right-0"
                    onClick={() => {
                      setIsEditing(true);
                    }}
                  >
