      ...
      <div className="mb-5">
        ...
        <div className="flex items-center justify-center">
          <div className="h-16 w-full">
            ...
            <div className="flex items-center justify-start">
              <span className="mt-[-25%] ml-[10%] text-xl text-white font-semibold z-40 ">
              ...
              <div className="h-auto w-64 bg-white cursor-pointer transition duration-500 ease-in-out hover:opacity-50 hover:shadow-xl ">
                ...
                <div className="flex items-center justify-center">
                  <div className="h-16 w-full bg-black border shadow-xl rounded-md">
                    ...
                    <div className="flex items-center justify-start">
                      <span class="ml-3 text-md font-medium text-white line-through ">
                        $109
                      </span>
                      <span class="ml-3 text-white text-md font-medium">
                        $79
                      </span>
                    </div>
                  </div>
