  ...
  const handleBooking = async () => {
    ...
    if (!dateTaking) {
      ...
      const differenceInDays = Math.floor(
        (dateTakingObject - dateTryCostumerObject) / oneDayInMillis
      );
      ...
      const differenceFromNow = Math.floor(
        (dateTakingObject - new Date()) / oneDayInMillis
      );
    ...
    if (result.error) {
      ...
      notify(
        "Đặt lịch thành công! Hãy để ý điện thoại và email chúng tôi sẽ liên lạc sớm nhất có thể",
        "success"
      );
  ...
  return (
    <>
      ...
      <div className="w-full bg-black">
        <img
          src="https://firebasestorage.googleapis.com/v0/b/fotofushion-51865.appspot.com/o/FrojectImage%2Fbgbooking.png?alt=media&token=ab70de9e-1783-4f94-a4bc-bf2c870f0fcf"
          alt=""
        />
        <div className="flex justify-center items-center mt-[-26%]">
          <div className="w-full p-4">
            <div className="w-[40%] mx-auto bg-white shadow-lg rounded-lg overflow-hidden max-sm:w-full max-sm:text-xs  max-md:w-full max-md:text-xs max-xl:w-[90%] max-xl:text-lg">
              <div className="text-2xl py-4 px-6 bg-btnprimary text-white text-center font-bold uppercase">
                ĐẶT LỊCH TRỰC TUYẾN
              </div>
                ...
                <div className="border p-4 rounded shadow-sm m-2 max-sm:w-full">
                  ...
                  <div className="flex items-center justify-between  max-sm:text-xs">
                    <div className="mb-4 w-[48%]">
                      ...
                      <input
                        className="shadow appearance-none border rounded w-full py-2 px-3 text-black font-semibold  max-sm:text-xs leading-tight focus:outline-none focus:shadow-outline"
                        id="name"
                        type="text"
                        value={auth.fullName}
                        readOnly
                    ...
                    <div className="mb-4 w-[48%]">
                      ...
                      <input
                        className="shadow appearance-none border rounded w-full py-2 px-3 text-black max-sm:text-xs font-semibold leading-tight focus:outline-none focus:shadow-outline"
                        id="phoneNumber"
                        type="number"
                        value={auth.phone}
                        readOnly
                  ...
                  <div className="mb-4 max-sm:text-xs">
                    ...
                    <input
                      className="shadow appearance-none border rounded w-full py-2 px-3 max-sm:text-xs text-black font-semibold leading-tight focus:outline-none focus:shadow-outline"
                      id="email"
                      type="email"
                      value={auth.email}
                      readOnly
                  ...
                  <div className="flex items-end justify-end">
                    <Link to="/profile">
                      <Button className="bg-green-400 right-0">
                        Chỉnh sửa
                      </Button>
                    </Link>
                  </div>
            ...
            <div className="p-4 border rounded shadow-sm m-2 bg-white">
              <div className="w-full flex items-center justify-center">
                <div className="w-full text-2xl py-4 px-6 bg-btnprimary text-white text-center font-bold uppercase border rounded-xl">
                  THÔNG TIN ĐẶT LỊCH
                </div>
              </div>
              ...
              <div className="w-full mt-6">
                <div className="flex items-start justify-center max-sm:grid max-sm:grid-cols-1 max-md:grid max-md:grid-cols-2">
                  <div className="mb-4 w-[23%] max-sm:w-full max-md:w-full">
                    <label
                      className="block text-gray-700 font-bold mb-2"
                      for="date"
                    >
                    ...
                    <input
                      ...
                      onChange={(event) => setdateTaking(event.target.value)}
                    />
                  </div>
                  <div className="mb-4 w-[23%] max-sm:w-full max-md:w-full">
                    <label
                    ...
                    >
                      <option disabled selected>
                        Chọn thể loại bạn muốn chụp
                      </option>
                      <option value="studio">
                        Chụp tại Studio :
                        <p>{selectedRoom !== null && selectedRoom.name}</p>
                      </option>
                      ...
                      <div className="flex items-center justify-start max-sm:w-full max-sm:grid max-sm:grid-cols-1">
                        <div className="mb-4 w-2/3">
                          ...
                          <input
                            ...
                            placeholder="Select a date"
                            onChange={(event) =>
                              setDateTryCostumer(event.target.value)
                            }
                          />
                        </div>
                      </div>
                  ...
                  <div className="mb-4 w-[23%] max-sm:w-full max-md:w-full">
                    ...
                    >
                      ...
                      <option value="thuemakeup">
                        Thuê :{" "}
                        <p>{selectedMakeUp !== null && selectedMakeUp.name}</p>
                      </option>
                ...
                <div className="w-full">
                  {display === "studio" && (
                    <RoomStudio onSelectRoom={setSelectRoom} />
                  )}
                  {display === "ngoaiCanh" && <LocationTakePhoto />}
                  {(display === "thuetrangphuc" || display === "mua") && (
                    <Costumer onSelectCostumer={setSelectCostumer} />
                  )}
                  {display === "thuemakeup" && (
                    <MakeUp onSelectMakeUp={setSelectMakeUp} />
                  )}
                </div>
              </div>
              <div className="mb-4">
                ...
                <textarea
                  ...
                  id="message"
                  rows="4"
                  placeholder="Nhập yêu cầu hoặc ý tưởng của bạn về buổi chụp bạn muốn"
